...
<script>  
  export default {
    ...
    <header class="c-Header">
      <h1 class="u-text-pink text-center">友達<a class="c-right-icon" href="/search"><img src="/images/close-icon.png" alt=""></a></h1>
      ...
      <div class="c-Header__tabs row">
        ...
        <div class="col text-center u-isActive--pink">
          <router-link to="/friends">私の友達</router-link>
        </div>
        <div class="col text-center u-isNoActive">
          <router-link to="/appo_friends">約束済み</router-link>
        </div>
      </div>
